...
export function Details({
  ...
  ///////
  return (
    <div className={styles.container} ref={containerRef} data-key="contact-form" style={{ position: isFooterFixed ? "fixed" : "relative" }}>
      ...
      <div className={styles.social}>
        <ul>
          <li>
            <Link href="https://linkedin.com/in/imdaudbut" passHref>
          ...
          <li>
            <Link href="https://github.com/drb372" passHref>
          ...
          <li>
            <Link href="mailto: daudbutt400@gmail.com" passHref>
