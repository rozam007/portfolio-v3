...
const PROJECTS: TProject[] = [
  new Project({
    ...
    roles: ["fs"],
    sitelink: "https://www.boosterhub.com/",
    ...
    responsibilities: `
		<ul>
		 <li>Develop various modules including chat, email, and file management.</li>
		 <li>CUtilize Node.js and Laravel APIs for development tasks.</li>
		 <li>Lead the creation of a sophisticated accounting system for managing club finances.</li>
		 <li>Design the Webmaster module allowing users to build custom websites within the Boosterhub platform.</li>
		 <li>Focus on delivering scalable and efficient solutions.</li>
		 <li>Enhance the club management experience for administrators and members.</li>
		</ul>
		`,
  }),
  {
    id: "monitairhealth",
    title: "Monitair Health",
    details: `
    ...
    responsibilities: `
		<ul>
			<li>Meticulously monitor therapy data for accuracy and security.</li>
			<li>Seamlessly integrate diverse health devices used by patients.</li>
			<li>Implement rigorous test-driven development practices.</li>
			
			<li>Ensure data accuracy and security to provide peace of mind to patients and healthcare providers.</li>
			<li>Provide detailed reports and insightful graphs for informed decision-making.</li>
			<li>Streamline invoicing processes to empower healthcare professionals in delivering personalized care effectively.</li>
		</ul>
		`,
    roles: ["fs"],
    sitelink: "https://monitairhealth.com",
    tech: [
      "nodejs",
      "react",
      "nestjs",
  ...
  },
  {
    ...
    responsibilities: `
		<ul>
			<li>Played a pivotal role in developing microservices dedicated to tour management.</li>
			<li>Utilized Node.js (Nest) for development tasks.</li>
			<li>Seamlessly integrated Stripe payment functionalities.</li>
			<li>Implemented rigorous test-driven development practices.</li>
			<li>Guarantees smooth transaction experiences through testing.</li>
		</ul>
		`,

    roles: ["teamlead"],
    sitelink: "https://www.tour27.com/",
    tech: [
      "nodejs",
      "react",
      "redux",
  ...
  {
    id: "veronicasinsurance",
    title: "Veronicas Insurance",
    details: `
    ...
    responsibilities: `
		<ul>
			<li>Overseeing agents and their tasks.</li>
			<li>Managing interactions between agents and customers.</li>
			<li>Integrating payment processing functionalities using Stripe.</li>
			<li>Implementing Twilio for communication purposes.</li>
			<li>Facilitating interactions with customers via calls and SMS.</li>
			<li>Enhancing overall service delivery and customer experience.</li>
			
		</ul>
		`,
    tech: ["nodejs", "microservices", "stripe"],
    roles: ["fs"],
    type: "Web Application",
    bgColor: "#f0f6ff",
    githublink: "https://github.com/obododavid/Medic-Finder",
    sitelink: "https://veronicas.com/",
    media: [
      {
        type: "image",
        source: medic1,
  ...
  },
  {
    ...
    responsibilities: `
		<ul>
			<li>Writing SQL queries for data retrieval and analysis</li>
			<li>Implementing data analytics solutions using Redshift, Cube Js, and Airflow.</li>
			<li>Building different jobs for scheduling workflows.</li>
			<li>Utilizing Node.js microservices architecture for development tasks.</li>
			<li>Bringing remote teams and managers together in an easy-to-use environment.</li>
			<li>Enhancing collaboration and productivity among remote teams through advanced analytics and project management functionalities.</li>
			
		</ul>
		`,
    sitelink: "https://levvy.com/",
    tech: [
      "nodejs",
      "microservices",
      "postgreSQL",
